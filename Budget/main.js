...
function getTotalBudget(amount) {
  if (!amount) {
    ...
    AmountRemaining.innerText = amount;
    expenseForm.style.display = "block";
...
function updateBalance() {
  AmountRemaining.innerText =
    parseInt(TotalBudget.innerText) - parseInt(TotalExpenses.innerText);
}
...
addForm.addEventListener("submit", (e) => {
  e.preventDefault();
  getTotalBudget(amountInput.value);
});